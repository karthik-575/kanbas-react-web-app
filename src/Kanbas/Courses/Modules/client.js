...
const COURSES_URL = `https://kanbas-node-server-app-8jx3.onrender.com/api/courses`;
const MODULES_URL = `https://kanbas-node-server-app-8jx3.onrender.com/api/modules`;
