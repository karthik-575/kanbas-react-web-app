...
function WorkingWithObjects() {
    ...
    return (
        <div className={'mt-3'}>
            ...
            <h4 className={'mt-1'}>Retrieving Properties</h4>
            <a
            ...
            <h4 className={'mt-1'}>Modifying Properties</h4>
            <a
            ...
            <button onClick={updateTitle} className="w-100 btn btn-primary mb-2 mt-2">
